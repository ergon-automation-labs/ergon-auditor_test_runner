defmodule BotArmyAuditorTestRunner.Skills.ExampleTest do
  @moduledoc """
  ...
  alias BotArmyAuditorTestRunner.Skills.Example
  ...
  describe "nats_triggers/0" do
    test "returns list of trigger subjects" do
      ...
      assert "bot.bot_army_auditor_test_runner.command.example" in triggers
    end
  end
