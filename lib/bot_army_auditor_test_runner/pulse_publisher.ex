defmodule BotArmyAuditorTestRunner.PulsePublisher do
  @moduledoc """
  Periodic health publisher for Test Runner Bot.
  ...
  2. **`bot.auditor_test_runner.pulse`** — richer metrics every 30 minutes (lower NATS volume).
  ...
  @service_name "auditor_test_runner"
  @envelope_source "bot_army_auditor_test_runner"
  ...
  @impl true
  def init(_opts) do
    Logger.info("[PulsePublisher] Starting Test Runner Bot pulse publisher")
