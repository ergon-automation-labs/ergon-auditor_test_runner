defmodule BotArmyAuditorTestRunner.Skills.Example do
  @moduledoc """
  Example skill for Test Runner Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_auditor_test_runner.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_auditor_test_runner.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_auditor_test_runner/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_auditor_test_runner.command.example"
    ]
  end
