...
release: check
	...
	@echo "==============================================="
	rm -rf _build/prod/rel/test_runner_bot
	MIX_ENV=prod $(MIX) release
	@echo ""
	@echo "✓ Release built successfully"
	@echo "Location: _build/prod/rel/test_runner_bot/"
	@echo ""
...
publish-release: release
	...
	TARBALL="test_runner_bot-$$VERSION.tar.gz"; \
	echo "Version: $$VERSION"; \
	echo "Creating release tarball..."; \
	tar -czf "$$TARBALL" -C _build/prod/rel test_runner_bot/; \
	...
	if gh release view "v$$VERSION" >/dev/null 2>&1; then \
		...
		gh release create "v$$VERSION" "$$TARBALL" \
			...
			--notes "Test Runner Bot Elixir release v$$VERSION. Download and deploy with Jenkins." \
			--draft=false; \
	fi; \
	...
	BOT_SHORT=$$(echo "test_runner_bot" | sed 's/_bot$$//'); \
